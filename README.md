...
<details open>
  ...
  --|--|--
  [isalpha](./src/util/zen_isalpha.c) | `int  zen_isalpha(int c);` | _check for alphabetic character_
  [isdigit](./src/util/zen_isdigit.c) | `int  zen_isdigit(int c);` | _check for digit (`0` through `9`)_
  [isalnum](./src/util/zen_isalnum.c) | `int  zen_isalnum(int c);` | _check for alphanumeric character_
